<x-layout title="Editar amigo">
  <form action="/amigos/{{ $amigo->id }}" method="post" id="formulario">
    ...
    <div class="mb-3">
       ...
       <div class="col-3">
         <input type="text" name="name" id="name" class="form-control" value="{{ $amigo->name }}" oninput="checkInput()">
       </div>
       <label for="email" class="form-label mt-2">E-mail:</label>
       <div class="col-3 mt-2">
         <input type="text" name="email" id="email" class="form-control" value="{{ $amigo->email }}" oninput="checkInput()">
       </div>
    </div>
