<x-layout title="Adicionar novo amigo">
  <form action="/amigos" method="post" id="formulario">
    ...
    <div class="mb-3">
       ...
       <div class="col-3">
         <input type="text" name="name" id="name" class="form-control" style="width: 320px;" oninput="checkInput()">
       </div>
       <label for="email" class="form-label mt-2">E-mail:</label>
       <div class="col-3 mt-2">
         <input type="email" name="email" id="email" class="form-control" style="width: 320px;" oninput="checkInput()">
       </div>
    </div>
